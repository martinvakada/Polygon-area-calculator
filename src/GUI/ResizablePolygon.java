...
public class ResizablePolygon extends JPanel {
    ...
    private Polygon p;
    private final int v_size = 8; //size of the square to denote the corner of the polygon
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.draw(poly); //draw the polygon
        g2.drawString("A", xs[0] - 10, ys[0] - 10); //draw A at the vertex
    ...
    class ShapeResizeHandler extends MouseAdapter {
        ...
        //resets all parameters of polygon according to the change in the position of any vertex
